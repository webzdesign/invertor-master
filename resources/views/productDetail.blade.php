...
<section class="review">
    <div class="container">
        ...
        <div>
                    ...
                    <div class="review-card py-3 border-bottom border-gray-300">
                                ...
                                @for ($i = 1; $i <= 5; $i++)
                                    <svg width="16" height="15" viewBox="0 0 16 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path 
                                            ...
                                            fill="{{ $i <= $review->rating ? '#F7B408' : '#E0E0E0' }}"
                                        />
                                    </svg>
                                @endfor
                            </div>
                            <p class="m-0 text-sm text-gray-500 font-inter-regular"> {{ $review->created_at->format('M d') }} @if($review->created_at->diffInDays(now()) > 1) - {{ $review->created_at->diffInDays(now()) }} {{ __('days ago') }} @endif</p>
                        </div>
                        <div class="my-2 d-flex align-items-center gap-3 flex-wrap">
                            <h3 class="m-0 text-slate-900 text-2xl text-xl-mob font-medium">{{ $review->customer_name }}</h3>
                        ...
                        <div class="d-flex align-items-center gap-2">
                            ...
                            @else
                                ...
                                <span class="font-inter-regular text-danger text-sm">No</span>
                                </div>
                            @endif
                        </div>
                    </div>  
            ...
            @else 
                <div class="review-card py-3 border-bottom border-gray-300">
                    <span>{{__('No Review Available!')}}</span>
                </div>
            @endif
            {{-- <div class="review-card py-3 border-bottom border-gray-300">
                <div class="d-flex align-items-center gap-1">
                ...
                <div class="d-flex align-items-center gap-2">
                    ...
                    <div class="d-flex align-items-center gap-1">
                        ...
                        <span class="text-blue-500 text-sm font-inter-regular">Yes</span>
                    </div>
                </div>
            </div> --}}
        </div>
