<html lang="en">
    <head>
        ...
        <style>
            ...
            src: url("{{ asset('assets/font/helvetica_n4.woff2') }}") format("woff2");
            }
            @font-face {
            font-family: Helvetica;
            font-weight: 700;
            font-style: normal;
            font-display: fallback;
            src: url("{{ asset('assets/font/helvetica_n7.woff2') }}") format("woff2");
            }
        </style>
        <script>
        ...
        <script src="{{ asset('assets/js/vendor.min.js') }}" defer="defer"></script>
        <script src="{{ asset('assets/js/theme.js') }}" defer="defer"></script>
        <script src="{{ asset('assets/js/snapuk.min.js') }}"></script>
    ...
    <body class="template-collection swatch-method-standard swatch-style-listed cc-animate-enabled tab-used" data-cc-animate-timeout="0">
