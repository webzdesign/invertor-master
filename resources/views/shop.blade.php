...
<section class="strore-banner p-2 position-relative">
    ...
    <h2 class="text-slate-50 position-absolute top-50 translate-middle left-50 font-bebas whitespace-nowrap mb-0">@if($categoryName !='') {{$categoryName}} @else Our Store @endif</h2>
</section>
