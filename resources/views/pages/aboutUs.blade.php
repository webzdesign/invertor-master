    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-xxl-4 col-md-6 mt-4">
                <div class="bg-gray-500 rounded-3xl p-4">
                    ...
                    <p class="text-slate-50 text-sm font-inter-regular mb-0">Vehicle Solutions Limited otherwise known as Skootz is a UK based Company of high-quality e-scooters and e-bikes. It aims to encourage emission-free travel while delivering exceptional customer service</p>                         
                </div>
            </div>
            <div class="col-xxl-4 col-md-6 mt-4">
                <div class="bg-slate-950 rounded-3xl p-4">
            ...
            <div class="col-xxl-4 col-md-6 mt-4">
                <div class="bg-slate-950 rounded-3xl p-4">
                    ...
                    <p class="text-slate-50 text-sm font-inter-regular mb-0">- Klarna and Laybuy as convenient payment options.</p>                         
