...
@section('content')
    ...
    <section class="strore-banner p-2 position-relative">
        <img src="{{ asset('assets/images/inv-our-store-banner.webp') }}" alt="Invertor Lux team" width="100%"
            class="rounded-3xl d-none d-sm-block">
        <img src="{{ asset('assets/images/inv-our-store-banner-mob.webp') }}" alt="Invertor Lux team" width="100%" class="d-sm-none">
