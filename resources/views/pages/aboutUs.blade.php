...
<section class="strore-banner p-2 position-relative">
    ...
    <h2 class="text-slate-50 position-absolute top-50 translate-middle left-50 font-bebas whitespace-nowrap mb-0">{{ __('About')}} {{ config('app.name') }}</h2>
</section>
        ...
        <div class="row">
            <div class="col-xxl-4 col-md-6 mt-4">
                <div class="sz_about_skootz_sec bg-slate-950 rounded-3xl p-4">
                    ...
                    <p class="text-slate-50 text-sm font-inter-regular mb-0">{{ __('Skootz is a UK based Company of high-quality e-scooters and e-bikes. It aims to encourage emission-free travel while delivering exceptional customer service')}}</p>
                </div>
            </div>
            <div class="col-xxl-4 col-md-6 mt-4">
                <div class="sz_about_skootz_sec bg-slate-950 rounded-3xl p-4">
                    ...
                    <h3 class="text-slate-50 font-semibold font-hubot text-xl mt-4">{{ __('What is Skootz\'s mission?')}}</h3>
                    <p class="text-slate-50 text-sm font-inter-regular mb-0">{{ __('Skootz is on a mission to boost emission-free travel through high quality e-scooters and e-bikes. Urban transportation is revolutionized and provides a more sustainable means by which to get around.')}}</p>
                </div>
            </div>
            <div class="col-xxl-4 col-md-6 mt-4">
                <div class="sz_about_skootz_sec bg-slate-950 rounded-3xl p-4">
                    ...
                    <h3 class="text-slate-50 font-semibold font-hubot text-xl mt-4">{{ __('What support Skootz offer?')}}</h3>
                    <p class="text-slate-50 text-sm font-inter-regular mb-0">{{ __('Skootz offers a range of support services, including:')}}</p>
                    <p class="text-slate-50 text-sm font-inter-regular mb-0">- {{ __('Maintenance and repair expert technical support.')}}</p>
                    <p class="text-slate-50 text-sm font-inter-regular mb-0">- {{ __('Stripe and Cash On Delivery as convenient payment options.')}}</p>
                    <p class="text-slate-50 text-sm font-inter-regular mb-0">- {{ __('Products of different select and range.')}}</p>
                </div>
            </div>
        </div>
    </div>
