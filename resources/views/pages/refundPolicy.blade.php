...
<section class="bg-linear linear-banner rounded-3xl p-2 m-2 position-relative">
    ...
    <h2 class="text-slate-50 position-absolute top-50 translate-middle left-50 font-bebas whitespace-nowrap mb-0 text-6xl text-4xl-mob">{{ __('Refund & Cancellation Policy')}}</h2>
</section>
