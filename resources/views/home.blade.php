            ...
            <div class="owl-item-hero">
                <div class="row align-items-center">
                    <div class="col-xl-6 col-lg-8 left-slide">
                        ...
                        <a href="javascript:void(0);" class="fadeItem order-btn mx-auto mx-lg-0 bg-slate-900 d-flex align-items-center justify-content-between rounded-pill ps-3 pe-2 mt-5 text-decoration-none text-white font-semibold text-lg mb-4 AddToCartBtn" data-pid="{{encrypt($slider_product->id)}}">
                            Order Now 
    ...
    <div class="container">
        <div class="d-flex flex-wrap align-items-center justify-content-between">
            ...
            <div class="top-content">
                ...
                <a href="javascript:;" class="button-dark mt-3">See our collections</a>
            </div>
        </div>
        <div class="row mt-5">
